...
for (let j = 0; j < firstWire.length; j++) {
  if (firstWire[j].charAt(0) == "R") {
     for (let a = 0; a < parseInt(firstWire[j].substring(1,firstWire[j].length)); a++) {
       currentX++;
       matrix[currentX][currentY] = 1;
     }
  }
  else if (firstWire[j].charAt(0) == "L") {
     for (let a = 0; a < parseInt(firstWire[j].substring(1,firstWire[j].length)); a++) {
       currentX--;
       matrix[currentX][currentY] = 1;
     }
  }
  else if (firstWire[j].charAt(0) == "U") {
     for (let a = 0; a < parseInt(firstWire[j].substring(1,firstWire[j].length)); a++) {
       currentY++;
       matrix[currentX][currentY] = 1;
     }
...
for (let j = 0; j < secondWire.length; j++) {
  if (secondWire[j].charAt(0) == "R") {
     for (let a = 0; a < parseInt(secondWire[j].substring(1,secondWire[j].length)); a++) {
       currentX++;
       calculateDistance();
       matrix[currentX][currentY] = 2;
     }
  }
  else if (secondWire[j].charAt(0) == "L") {
     for (let a = 0; a < parseInt(secondWire[j].substring(1,secondWire[j].length)); a++) {
       currentX--;
       calculateDistance();
       matrix[currentX][currentY] = 2;
  ...
  else if (secondWire[j].charAt(0) == "U") {
     for (let a = 0; a < parseInt(secondWire[j].substring(1,secondWire[j].length)); a++) {
       currentY++;
       calculateDistance();
       matrix[currentX][currentY] = 2;
...
function calculateDistance() {
  if (matrix[currentX][currentY] == 1) {
         let newDistance = Math.abs(currentX - centerX) + Math.abs(currentY - centerY);
